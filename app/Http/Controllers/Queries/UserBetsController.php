...
class UserBetsController extends Controller
{
	public function query()
	{
		...
		$bets = DB::table('users')
		->select(['bets.credits_placed','bets.credits_won as total_won','bet_details.credits_won','bet_details.won','questions.description','question_answers.answer','bet_details.user_answer', 'bets.created_at as time_placed'])
